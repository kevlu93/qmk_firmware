...
[_QWERTY] = LAYOUT_plaid_grid(
    ...
    KC_LCTL,  KC_LGUI, KC_PSCR, KC_LALT, LOWER,   KC_SPC,  KC_ENT,  RAISE,   KC_RALT, KC_DOWN, KC_UP,   KC_RSFT
),
...
[_LOWER] = LAYOUT_plaid_grid(
    ...
    KC_LSFT,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_LEFT,   KC_DOWN,    KC_UP,    KC_RIGHT, KC_RCBR, KC_BSLASH,
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_LBRC,  KC_RBRC,  S(KC_NUHS), S(KC_NUBS), KC_HOME, KC_END,  _______,
